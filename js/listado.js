...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    const ciudadesRepetidas = this.restaurantes.map(function(restaurant){
        return restaurant.ubicacion;
    });
    // Devuelo el array sin ciudades repetidas
        return this.eliminarRepetidos(ciudadesRepetidas).sort();
}
...
Listado.prototype.obtenerRubros = function() {
    const rubrosRepetidos =  this.restaurantes.map(function(restaurant){
        return restaurant.rubro;
    });
    // Devuelo el array sin ciudades repetidas
    return this.eliminarRepetidos(rubrosRepetidos).sort();
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    const Horariecitos = this.restaurantes.map(function(restaurant){
        return restaurant.horarios;
    });

    //En este arreglo vamos a poner todos los horarios, uno por uno
    const horarios = [];
    Horariecitos.forEach(function(elem) {
...
Listado.prototype.eliminarRepetidos = function(listaElementos) {
